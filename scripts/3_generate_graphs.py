...
def main_days(host, database, username, password, output_csv, output_gnuplot, output_img):
 ...
 :param str host: Database name
 :param str username: Database username
 :param str password: Database password
 :param str output_csv: Path to the CSV file to generate
 :param str output_gnuplot: Path to the Gnuplot file to generate
 :param str output_img: Path to the image file that will be generated by the Gnuplot script
 """
